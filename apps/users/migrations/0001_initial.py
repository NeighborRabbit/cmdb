# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-09-06 08:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menus', models.ManyToManyField(blank=True, to='users.Menu', verbose_name='动态菜单')),
            ],
            options={
                'verbose_name': '角色',
        ...
        migrations.AlterUniqueTogether(
            name='menu',
            unique_together=set([('title', 'url_name')]),
        ),
    ]
